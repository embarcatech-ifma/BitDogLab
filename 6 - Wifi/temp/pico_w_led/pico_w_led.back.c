...
#define WIFI_SSID "EngenhariaEletricaIndustrialIFMA"
#define WIFI_PASS "S0m0s0sM3lh0r3sIFMA2020"
...
while (!stdio_usb_connected()) {
    sleep_ms(200); // Aguarda 200 ms antes de verificar de novo
}

    // Inicializa o módulo Wi-Fi (CYW43439)
    // Se retornar valor diferente de zero, houve erro na inicialização
    if (cyw43_arch_init()) {
        printf("Falha ao inicializar o módulo CYW43439\n"); // Mensagem de erro
        return -1; // Encerra o programa com código de erro
    }

    printf("Módulo inicializado com sucesso!\n");
